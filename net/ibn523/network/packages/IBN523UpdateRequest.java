...
public class IBN523UpdateRequest extends GeneralPacket {	
	public int x;
	public int y;
	public int z;

	public IBN523UpdateRequest() {
		super("IBN523",PacketIDs.IBN523_REQ);
	}
	public IBN523UpdateRequest(int x, int y, int z) {
		this();
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public String toString() {
		return "IBN523UpdateRequest:["+x+","+y+","+z+"]";
	}
}
